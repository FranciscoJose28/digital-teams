...
fecharParticipanteBtn.onclick = () => {
  ...
  formParticipante.classList.remove('remove')
}
      ...
      listTeams.innerHTML += `
          <li>
             ...
             <div class="actions">
                ...
                <button onClick="removerCard(${i})"><box-icon name="trash-alt" type="solid"></box-icon></button>
             </div>
          </li>
        `;
    }
...
function mostrarFormParticipante(){
  overlay.classList.add("show");
